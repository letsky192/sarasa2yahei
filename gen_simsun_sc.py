...
def gen_simsun_sc():
    fs.copy(utils.DOWNLOAD_DIR + '/SarasaMonoSC-Regular.ttf', utils.DOWNLOAD_DIR + '/SarasaMonoSC-Regular-new.ttf')
    ...
    font_ui = utils.open_font(utils.DOWNLOAD_DIR + '/SarasaMonoSC-Regular-new.ttf')
